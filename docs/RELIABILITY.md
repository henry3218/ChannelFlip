...
**Still required for the new core:** a live audio-host trace under pressure and across real sleep/resume, plus listening. 新核心仍需實機記錄音訊中斷、page fault 與睡眠喚醒；隔離測試不能代替這項驗收。
