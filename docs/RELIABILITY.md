...
**Live pressure and listening passed:** the frozen 2.3.0 candidate passed continuous playback with 512 MiB pressure and off/on comparisons. The continuous trace recorded no Glitch events or AudioDG hard faults; the earlier short-tone trace's nonzero events remain documented. Actual sleep/resume remains unverified, with a Mobile Hotspot AWAYMODE request identified. See the [hardware record and exact artifact hashes](HARDWARE-2.3.0.md). 新核心已有實際宿主壓力追蹤及使用者聽感確認；真正睡眠喚醒尚待驗證，不能以隔離測試或計數器代替。
